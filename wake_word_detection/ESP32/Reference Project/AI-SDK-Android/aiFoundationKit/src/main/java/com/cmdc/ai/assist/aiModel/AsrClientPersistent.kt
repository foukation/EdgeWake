...
internal class AsrClientPersistent(serverUri: URI) : WebSocketClient(serverUri) {
    ...
    private fun saveAudioData(audioBuffer: ByteArrayOutputStream) {
        ...
        val wavFilePath = AudioFileUtils.saveToWavFile(audioData, "SpeechRecognitionPersistent")
        val pcmFilePath = AudioFilePcmUtils.saveToPcmFile(audioData, "SpeechRecognitionPersistent")
