package com.fxzs.lingxiagent.lingxi.core.viewnode
...
import com.fxzs.lingxiagent.lingxi.core.utils.ScreenAdapter
import com.fxzs.lingxiagent.lingxi.core.utils.ViewChildList
...
class ViewNode : ViewOperation, Comparable<ViewNode> {
    ...
    override fun globalClick(): Boolean {
        ...
        return runBlocking {
            com.fxzs.lingxiagent.lingxi.core.api.click(relp.x, relp.y)
        }
    }

    override suspend fun globalLongClick(): Boolean {
        val relp = ScreenAdapter.getRelPoint(getCenterPoint())
        return com.fxzs.lingxiagent.lingxi.core.api.longClick(relp.x, relp.y)
    }
