 ...
 */
package com.fxzs.lingxiagent.lingxi.easyfloat.permission.rom;
...
public class MiuiUtils {
    ...
    public static int getMiuiVersion() {
        ...
        if (version != null) {
            try {
                ...
                Timber.tag(TAG).e( "get miui version code error, version : " + version);
    ...
    private static boolean checkOp(Context context, int op) {
        ...
        if (version >= 19) {
            ...
            Timber.tag(TAG).e( "Below API 19 cannot invoke!");
        }
        return false;
    }
    ...
    public static void applyMiuiPermission(Fragment fragment) {
        ...
        if (versionCode == 5) {
            ...
            Timber.tag(TAG).e( "this is a special MIUI rom version, its version code " + versionCode);
        }
    }
    ...
    public static void goToMiuiPermissionActivity_V5(Fragment fragment) {
        ...
        if (isIntentAvailable(intent, fragment.getActivity())) {
            ...
            Timber.tag(TAG).e( "intent is not available!");
        }
    }
