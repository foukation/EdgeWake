...
import com.fxzs.lingxiagent.lingxi.core.utils.GestureCanceledException
...
suspend fun swipeDirection(
    ...
    // 边界约束：确保终点坐标不为负数且不超出屏幕范围
    endX = endX.coerceIn(0, ScreenAdapter.relWidth)
    endY = endY.coerceIn(0, ScreenAdapter.relHeight)
