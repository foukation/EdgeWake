...
public final class AutoGestureDescription {
    ...
    public static class StrokeDescription {
        ...
        int mId;
        boolean mContinued;
        public int mContinuedStrokeId = INVALID_STROKE_ID;
    ...
    public static class TouchPoint implements Parcelable {
        ...
        public static final @NonNull Creator<TouchPoint> CREATOR
    ...
    public static class GestureStep implements Parcelable {
        ...
        public static final @NonNull Creator<GestureStep> CREATOR
