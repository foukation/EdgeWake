...
static const char* TAG = "NoAudioCodec";
...
NoAudioCodecSimplexPdm::NoAudioCodecSimplexPdm(int input_sample_rate, int output_sample_rate,
    ...
    : NoAudioCodecSimplexPdm(input_sample_rate, output_sample_rate,
...
NoAudioCodecSimplexPdm::NoAudioCodecSimplexPdm(int input_sample_rate, int output_sample_rate,
    ...
    tx_chan_cfg.dma_desc_num = AI_SDK_AUDIO_CODEC_DMA_DESC_NUM;
    tx_chan_cfg.dma_frame_num = AI_SDK_AUDIO_CODEC_DMA_FRAME_NUM;
